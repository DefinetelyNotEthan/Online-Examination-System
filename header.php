	      ...
	      <li><h3 id ="navWelcome"> Welcome,  <?php echo $_SESSION['firstName']." ".$_SESSION['lastName']; ?></h3></li>
			<li>		      <div class="dropdown show">
				  <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDhVoqZVRdPWcuTCEHaphmign8QVLxGeyCXQ&usqp=CAU" alt="Avatar" class="rounded-circle" alt="Cinque Terre" height ="40px" id ='profileIMG'>
				  </a>
