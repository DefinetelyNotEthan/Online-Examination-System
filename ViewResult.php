...
<head>
 ...
 <script src="ExamResult.js"></script>
...
<div class = "content">
  ...
  <div class = "QuestionBox">
   ...
   <?php
        ...
        $userQuery= "SELECT * FROM exam WHERE userID = $userID and checked = 'YES'";
      ...
      <div class = "qForm">
        <form>
            <select id="uncheckedExamID_select" name="uncheckedExamID_select">
             ...
             <input type="button" type="button" class="btn btn-info btn-small" onclick="showS()" value ="Show the Result" >
        <br>
